...
import (
	...
	dkgconfig "github.com/goplugin/pluginv3.0/v2/core/services/ocr2/plugins/dkg/config"
...
func validateSpec(tree *toml.Tree, spec job.Job) error {
	...
	case types.Functions:
		// TODO validator for DR-OCR spec: https://app.shortcut.com/pluginlabs/story/54054/ocr-plugin-for-directrequest-ocr
		return nil
	case types.Mercury:
