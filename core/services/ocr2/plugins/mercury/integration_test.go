...
import (
	...
	relaymercury "github.com/goplugin/plugin-data-streams/mercury"

	"github.com/goplugin/pluginv3.0/v2/core/bridges"
	"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets"
	token "github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/link_token_interface"
	...
	reportcodecv1 "github.com/goplugin/pluginv3.0/v2/core/services/relay/evm/mercury/v1/reportcodec"
	reportcodecv2 "github.com/goplugin/pluginv3.0/v2/core/services/relay/evm/mercury/v2/reportcodec"
	reportcodecv3 "github.com/goplugin/pluginv3.0/v2/core/services/relay/evm/mercury/v3/reportcodec"
...
func integration_MercuryV1(t *testing.T) {
	...
	linkFeed := Feed{"PLI/USD", randomFeedID(1), big.NewInt(7150 * multiplier / 1000), big.NewInt(7123 * multiplier / 1000), big.NewInt(7177 * multiplier / 1000)}
