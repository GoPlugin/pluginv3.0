...
import (
	...
	ocr2vrftypes "github.com/goplugin/plugin-vrf/types"

	commonconfig "github.com/goplugin/plugin-common/pkg/config"
	commonutils "github.com/goplugin/plugin-common/pkg/utils"
	...
	dkg_wrapper "github.com/goplugin/pluginv3.0/v2/core/gethwrappers/ocr2vrf/generated/dkg"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/ocr2vrf/generated/load_test_beacon_consumer"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/ocr2vrf/generated/vrf_beacon"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/ocr2vrf/generated/vrf_beacon_consumer"
	vrf_wrapper "github.com/goplugin/pluginv3.0/v2/core/gethwrappers/ocr2vrf/generated/vrf_coordinator"
...
`, uni.beaconAddress.String(),
	...
	// = (request overhead) * (gas price) / (PLI/ETH ratio)
	// = (50_000 * 1 Gwei) / .01
	// = 5_000_000 GJuels
	...
	// There is no premium on this request, so the cost of the request should have been:
	// = (request overhead + callback gas allowance) * (gas price) / (PLI/ETH ratio)
	...
	// = ((request overhead + callback gas allowance) * (gas price) / (PLI/ETH ratio)) * batch size
