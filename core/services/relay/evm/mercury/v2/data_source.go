...
import (
	...
	v2types "github.com/goplugin/plugin-common/pkg/types/mercury/v2"
	v2 "github.com/goplugin/plugin-data-streams/mercury/v2"
	...
	"github.com/goplugin/pluginv3.0/v2/core/services/relay/evm/mercury/v2/reportcodec"
	...
	if ds.feedID == ds.linkFeedID {
		...
		go func() {
			...
			if obs.LinkPrice.Val == nil && obs.LinkPrice.Err == nil {
				...
				ds.lggr.Warnw(fmt.Sprintf("Mercury server was missing PLI feed, using sentinel value of %s", v2.MissingPrice), "linkFeedID", ds.linkFeedID)
