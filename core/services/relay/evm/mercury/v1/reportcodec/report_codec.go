...
import (
	...
	reporttypes "github.com/goplugin/pluginv3.0/v2/core/services/relay/evm/mercury/v1/types"
)

// NOTE:
// This report codec is based on the original median evmreportcodec
// here:
// https://github.com/goplugin/offchain-reporting/blob/master/lib/offchainreporting2/reportingplugin/median/evmreportcodec/reportcodec.go
