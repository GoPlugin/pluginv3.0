...
import (
	...
	assets "github.com/goplugin/plugin-common/pkg/assets"

	client "github.com/goplugin/pluginv3.0/v2/core/chains/evm/client"
...
func (_c *Client_PLIBalance_Call) Return(_a0 *assets.Link, _a1 error) *Client_PLIBalance_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Client_PLIBalance_Call) RunAndReturn(run func(context.Context, common.Address, common.Address) (*assets.Link, error)) *Client_PLIBalance_Call {
	_c.Call.Return(run)
	return _c
}
