...
//go:generate mockery --name Encoder --structname MockEncoder --srcpkg "github.com/goplugin/plugin-common/pkg/types/automation" --case underscore --filename encoder.generated.go

//go:generate mockery --name LogEventProvider --structname MockLogEventProvider --srcpkg "github.com/goplugin/plugin-common/pkg/types/automation" --case underscore --filename logeventprovider.generated.go

//go:generate mockery --name RecoverableProvider --structname MockRecoverableProvider --srcpkg "github.com/goplugin/plugin-common/pkg/types/automation" --case underscore --filename recoverableprovider.generated.go

//go:generate mockery --name ConditionalUpkeepProvider --structname MockConditionalUpkeepProvider --srcpkg "github.com/goplugin/plugin-common/pkg/types/automation" --case underscore --filename conditionalupkeepprovider.generated.go

//go:generate mockery --name PayloadBuilder --structname MockPayloadBuilder --srcpkg "github.com/goplugin/plugin-common/pkg/types/automation" --case underscore --filename payloadbuilder.generated.go

//go:generate mockery --name BlockSubscriber --structname MockBlockSubscriber --srcpkg "github.com/goplugin/plugin-common/pkg/types/automation" --case underscore --filename block_subscriber.generated.go

//go:generate mockery --name UpkeepStateUpdater --structname MockUpkeepStateUpdater --srcpkg "github.com/goplugin/plugin-common/pkg/types/automation" --case underscore --filename upkeep_state_updater.generated.go
