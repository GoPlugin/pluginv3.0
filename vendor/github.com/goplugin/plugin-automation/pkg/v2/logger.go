...
//
//go:generate mockery --name Logger --structname MockLogger --srcpkg "github.com/goplugin/plugin-libocr/commontypes" --case underscore --filename logger.generated.go
