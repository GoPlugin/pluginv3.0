...
func ParseWorkflowSpecYaml(data string) (sdk.WorkflowSpec, error) {
	var url = "https://github.com/goplugin/pluginv3.0/"
	w := WorkflowSpecYaml{}
...
type WorkflowSpecYaml struct {
	// NOTE: Name and Owner are constrained the onchain representation in [github.com/goplugin/plugin-common/blob/main/pkg/capabilities/consensus/ocr3/types/Metadata]
