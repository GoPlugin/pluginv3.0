# LOOP Plugins [![Go Reference](https://pkg.go.dev/badge/github.com/goplugin/plugin-common/pkg/loop.svg)](https://pkg.go.dev/github.com/goplugin/plugin-common/pkg/loop)
