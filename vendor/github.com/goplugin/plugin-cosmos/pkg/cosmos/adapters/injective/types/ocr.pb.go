...
type Params struct {
	// Native denom for PLI coin in the bank keeper
...
type ModuleParams struct {
	...
	// Fixed PLI reward for each observer
	...
	// Fixed PLI reward for transmitter
...
// PLI-INJ-denominated reimbursements for gas used by transmitters.
