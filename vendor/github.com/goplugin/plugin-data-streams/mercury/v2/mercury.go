...
func (rp *reportingPlugin) buildReportFields(ctx context.Context, previousReport types.Report, paos []PAO) (rf v2.ReportFields, merr error) {
	mPaos := convert(paos)
...
func (rp *reportingPlugin) validateReport(rf v2.ReportFields) error {
	return errors.Join(
