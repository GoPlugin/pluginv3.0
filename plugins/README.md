...
[plugin.Dockerfile](plugin.Dockerfile) extends the regular [core/plugin.Dockerfile](../core/plugin.Dockerfile)
...
via libocr's [LocalConfig.MinOCR2MaxDurationQuery](https://pkg.go.dev/github.com/goplugin/libocr/offchainreporting2plus/types#LocalConfig).
