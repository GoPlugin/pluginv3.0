...
describe('Operator', () => {
  ...
  describe('#onTokenTransfer', () => {
    describe('when called from any address but the PLI token', () => {
    ...
    describe('when called from the PLI token', () => {
      it('triggers the intended method', async () => {
        const callData = encodeOracleRequest(
          specId,
          to,
  ...
  describe('#oracleRequest', () => {
    describe('when called through the PLI token', () => {
      const paid = 100
    ...
    describe('when not called through the PLI token', () => {
      it('reverts', async () => {
        await evmRevert(
          operator
  ...
  describe('#fulfillOracleRequest', () => {
    ...
    describe('with a malicious requester', () => {
      ...
      // TODO BCF-3117
      // it('cannot call functions on the PLI token through callbacks', async () => {
      //   await evmRevert(
      ...
      describe('requester lies about amount of PLI sent', () => {
        it('the oracle uses the amount of PLI actually paid', async () => {
