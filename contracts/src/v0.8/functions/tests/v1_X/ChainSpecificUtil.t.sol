...
contract ChainSpecificUtil__getL1FeeUpperLimit_Arbitrum is FunctionsFulfillmentSetup {
  ...
  uint96 l1FeeEstimateJuels = uint96((1e18 * L1_FEE_ESTIMATE_WITH_OVERESTIMATION_WEI) / uint256(PLI_ETH_RATE));
  uint96 l1FeeJuels = uint96((1e18 * L1_FEE_WEI) / uint256(PLI_ETH_RATE));
