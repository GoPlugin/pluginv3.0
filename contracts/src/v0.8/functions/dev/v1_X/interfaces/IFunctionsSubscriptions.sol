...
/// @title Plugin Functions Subscription interface.
interface IFunctionsSubscriptions {
  struct Subscription {
    uint96 balance; // ═════════╗ Common PLI balance that is controlled by the Router to be used for all consumer requests.
  ...
  /// @notice Get details about the total amount of PLI within the system
  /// @return totalBalance - total Juels of PLI held by the contract
  ...
  /// @notice Remove a consumer from a Plugin Functions subscription.
  /// @dev Only callable by the Subscription's owner
  /// @param subscriptionId - ID of the subscription
  /// @param consumer - Consumer to remove from the subscription
  function removeConsumer(uint64 subscriptionId, address consumer) external;

  /// @notice Add a consumer to a Plugin Functions subscription.
  /// @dev Only callable by the Subscription's owner
  /// @param subscriptionId - ID of the subscription
