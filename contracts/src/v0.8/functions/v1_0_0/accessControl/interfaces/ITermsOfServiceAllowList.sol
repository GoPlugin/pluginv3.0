...
interface ITermsOfServiceAllowList {
  ...
  /// @param acceptor - The wallet address that has accepted the Terms of Service on the UI
  /// @param recipient - The recipient address that the acceptor is taking responsibility for
  /// @param r - ECDSA signature r data produced by the Plugin Functions Subscription UI
  /// @param s - ECDSA signature s produced by the Plugin Functions Subscription UI
  /// @param v - ECDSA signature v produced by the Plugin Functions Subscription UI
