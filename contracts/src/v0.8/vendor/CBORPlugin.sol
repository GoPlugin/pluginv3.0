...
library CBORPlugin {
  ...
  function encodeFixedNumeric(BufferPlugin.buffer memory buf, uint8 major, uint64 value) private pure {
    if(value <= 23) {
  ...
  function encodeBigNum(BufferPlugin.buffer memory buf, uint value) internal pure {
