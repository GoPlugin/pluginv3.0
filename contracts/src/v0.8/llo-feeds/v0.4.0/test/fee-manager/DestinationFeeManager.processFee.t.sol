...
contract DestinationFeeManagerProcessFeeTest is BaseDestinationFeeManagerTest {
  ...
  function test_nonAdminProxyUserCannotProcessFee() public {
    ...
    //process the fee
    ProcessFeeAsUser(DEFAULT_CONFIG_DIGEST, payload, USER, address(pli), 0, USER);
  }
  ...
  function test_processFeeAsProxy() public {
    ...
    processFee(DEFAULT_CONFIG_DIGEST, payload, USER, address(pli), 0);
  ...
  function test_processFeeWithUnwrappedNativePliAddress() public {
    ...
    processFee(DEFAULT_CONFIG_DIGEST, payload, USER, address(pli), DEFAULT_REPORT_NATIVE_FEE - 1);
  }
  ...
  function test_processFeeWithUnwrappedNativePliAddressExcessiveFee() public {
    ...
    processFee(DEFAULT_CONFIG_DIGEST, payload, PROXY, address(pli), DEFAULT_REPORT_NATIVE_FEE);
  ...
  function test_processFeeWithZeroNativeNonZeroPliReturnsChange() public {
    ...
    //call processFee should not revert as the fee is 0
    processFee(DEFAULT_CONFIG_DIGEST, payload, USER, address(pli), DEFAULT_REPORT_NATIVE_FEE);
