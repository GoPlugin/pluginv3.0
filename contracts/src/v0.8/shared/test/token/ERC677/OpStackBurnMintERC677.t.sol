...
contract OpStackBurnMintERC677Setup is BaseTest {
  ...
  function setUp() public virtual override {
    BaseTest.setUp();
    s_opStackBurnMintERC677 = new OpStackBurnMintERC677("Plugin Token", "PLI", 18, 1e27, s_l1Token, s_l2Bridge);
  }
}

contract OpStackBurnMintERC677_constructor is OpStackBurnMintERC677Setup {
  function testConstructorSuccess() public {
    string memory name = "Plugin token l2";
    string memory symbol = "PLI L2";
    uint8 decimals = 18;
