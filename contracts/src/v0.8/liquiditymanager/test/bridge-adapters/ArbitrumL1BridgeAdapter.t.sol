...
//
//  IERC20 internal constant L1_PLI = IERC20(0x514910771AF9Ca656af840dff83E8264EcF986CA);
...
//
//  IERC20 internal constant L2_PLI = IERC20(0xf97f4df75117a78c1A5a0DBb814Af92458539FB4);
...
//    );
//
//    deal(address(L1_PLI), OWNER, TOKEN_BALANCE);
...
//    L1_PLI.approve(address(s_l1BridgeAdapter), TOKEN_BALANCE);
//
//    vm.expectEmit();
//    emit TransferRouted(address(L1_PLI), address(s_l1BridgeAdapter), OWNER, L1_ERC20_GATEWAY);
//
//    uint256 expectedCost = s_l1BridgeAdapter.MAX_GAS() *
//      s_l1BridgeAdapter.GAS_PRICE_BID() +
//      s_l1BridgeAdapter.MAX_SUBMISSION_COST();
//
//    s_l1BridgeAdapter.sendERC20{value: expectedCost}(address(L1_PLI), OWNER, OWNER, TOKEN_BALANCE);
//  }
//
...
//    );
//
//    s_l1BridgeAdapter.sendERC20{value: expectedCost - 1}(address(L1_PLI), OWNER, OWNER, TOKEN_BALANCE);
//  }
//
