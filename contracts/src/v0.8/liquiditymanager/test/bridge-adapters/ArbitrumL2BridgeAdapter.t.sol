...
//    deal(address(L2_PLI), OWNER, TOKEN_BALANCE);
...
//    L2_PLI.approve(address(s_l2BridgeAdapter), TOKEN_BALANCE);
//
//    s_l2BridgeAdapter.sendERC20(address(L1_PLI), address(L2_PLI), OWNER, TOKEN_BALANCE);
//  }
//}
