...
contract KeeperRegistrar1_2Mock {
  ...
  {
    return (s_autoApproveConfigType, s_autoApproveMaxAllowed, s_approvedCount, s_keeperRegistry, s_minPLIJuels);
  }
}
