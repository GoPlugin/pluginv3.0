...
contract AutomationRegistryLogicA2_2 is AutomationRegistryBase2_2, Chainable {
    ...
    )
  {
    ...
    uint96 maxPliPayment = _getMaxPliPayment(hotVars, triggerType, upkeep.performGas, fastGasWei, pliNative);
   ...
   * @param amount the amount of PLI to fund, in jules (jules = "wei" of PLI)
   */
