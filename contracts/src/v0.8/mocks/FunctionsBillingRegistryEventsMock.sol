...
contract FunctionsBillingRegistryEventsMock {
    ...
    event ConfigSet(uint32 maxGasLimit,uint32 stalenessSeconds,uint256 gasAfterPaymentCalculation,int256 fallbackWeiPerUnitPli,uint32 gasOverhead);
    ...
    function emitConfigSet(uint32 maxGasLimit,uint32 stalenessSeconds,uint256 gasAfterPaymentCalculation,int256 fallbackWeiPerUnitPli,uint32 gasOverhead) public {
